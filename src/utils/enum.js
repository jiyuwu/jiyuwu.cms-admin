        ...
        _createClass(Enum, [
            {
                ...
                value: function get(val) {
                    return _classPrivateFieldGet(this, _list).find(function (item) {
                        return (
                            (item === null || item === void 0 ? void 0 : item.key) === val ||
                            (item === null || item === void 0 ? void 0 : item.value) === val
                        )
                    })
                },
            ...
            },
            {
                ...
                value: function getValue(val) {
                    ...
                    var def = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null
                    var content =
                        (_this$get2 = this.get(val)) === null || _this$get2 === void 0 ? void 0 : _this$get2.value
                    return !isEmpty(content) ? content : def
                },
            ...
            },
            {
                ...
                value: function getDesc(val) {
                    ...
                    var def = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null
                    var content =
                        (_this$get3 = this.get(val)) === null || _this$get3 === void 0 ? void 0 : _this$get3.desc
                    return !isEmpty(content) ? content : def
                },
